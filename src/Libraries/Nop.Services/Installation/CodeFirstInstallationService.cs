...
namespace Nop.Services.Installation
{
    public partial class CodeFirstInstallationService : IInstallationService
    {
        ...
        protected virtual void InstallProducts(string defaultUserEmail)
        {
            ...
            //desktops
            InstallDesktopProducts(productTemplateSimple, allProducts, pictureService);

            //notebooks
            InstallNotebookProducts(productTemplateSimple, allProducts, pictureService);

            //software
            InstallSoftwareProducts(productTemplateSimple, allProducts, pictureService);

            //camera and photo
            InstallCameraAndPhotoProducts(productTemplateSimple, allProducts, pictureService, productTemplateGrouped);

            //cell Phone
            InstallCellPhoneProducts(productTemplateSimple, allProducts, pictureService);

            //others
            InstallOtherProducts(productTemplateSimple, allProducts, pictureService);

            //shoes
            InstallShoesProducts(productTemplateSimple, allProducts, pictureService);

            //clothing
            InstallClothingProducts(productTemplateSimple, allProducts, pictureService);

            //accessories
            InstallAccessoryProducts(productTemplateSimple, allProducts, pictureService, productAvailabilityRange);

            //digital downloads
            InstallDigitalDownloadProducts(productTemplateSimple, allProducts, pictureService, downloadService, sampleDownloadsPath);
            
            //books
            InstallBookProducts(productTemplateSimple, allProducts, pictureService);

            //jewelry
            InstallJewelryProducts(productTemplateSimple, allProducts, pictureService);

            //gift cards
            InstallGiftCardProducts(productTemplateSimple, allProducts, pictureService, deliveryDate);
            ...
            //related products
            InstallRelatedProducts(allProducts);

            //product tags
            InstallProductTags(allProducts);

            //reviews
            InstallProductsReview(allProducts, defaultCustomer, defaultStore);

            //stock quantity history
            InstallStockQuantityHistory(allProducts);
        }

        protected virtual void InstallProductTags(Dictionary<string, Product> allProducts)
        {
            //product tags
            AddProductTag(allProducts["product25GiftCard"], "nice");
            AddProductTag(allProducts["product25GiftCard"], "gift");
            AddProductTag(allProducts["productNikeTailwind"], "cool");
            AddProductTag(allProducts["productNikeTailwind"], "apparel");
            AddProductTag(allProducts["productNikeTailwind"], "shirt");
            AddProductTag(allProducts["productBeatsPill"], "computer");
            AddProductTag(allProducts["productBeatsPill"], "cool");
            AddProductTag(allProducts["productNikeFloral"], "cool");
            AddProductTag(allProducts["productNikeFloral"], "shoes");
            AddProductTag(allProducts["productNikeFloral"], "apparel");
            AddProductTag(allProducts["productAdobePhotoshop"], "computer");
            AddProductTag(allProducts["productAdobePhotoshop"], "awesome");
            AddProductTag(allProducts["productUniversalTabletCover"], "computer");
            AddProductTag(allProducts["productUniversalTabletCover"], "cool");
            AddProductTag(allProducts["productOversizedWomenTShirt"], "cool");
            AddProductTag(allProducts["productOversizedWomenTShirt"], "apparel");
            AddProductTag(allProducts["productOversizedWomenTShirt"], "shirt");
            AddProductTag(allProducts["productAppleMacBookPro"], "compact");
            AddProductTag(allProducts["productAppleMacBookPro"], "awesome");
            AddProductTag(allProducts["productAppleMacBookPro"], "computer");
            AddProductTag(allProducts["productAsusN551JK"], "compact");
            AddProductTag(allProducts["productAsusN551JK"], "awesome");
            AddProductTag(allProducts["productAsusN551JK"], "computer");
            AddProductTag(allProducts["productFahrenheit"], "awesome");
            AddProductTag(allProducts["productFahrenheit"], "book");
            AddProductTag(allProducts["productFahrenheit"], "nice");
            AddProductTag(allProducts["productHtcOne"], "cell");
            AddProductTag(allProducts["productHtcOne"], "compact");
            AddProductTag(allProducts["productHtcOne"], "awesome");
            AddProductTag(allProducts["productBuildComputer"], "awesome");
            AddProductTag(allProducts["productBuildComputer"], "computer");
            AddProductTag(allProducts["productNikonD5500DSLR"], "cool");
            AddProductTag(allProducts["productNikonD5500DSLR"], "camera");
            AddProductTag(allProducts["productLeica"], "camera");
            AddProductTag(allProducts["productLeica"], "cool");
            AddProductTag(allProducts["productDigitalStorm"], "cool");
            AddProductTag(allProducts["productDigitalStorm"], "computer");
            AddProductTag(allProducts["productWindows8Pro"], "awesome");
            AddProductTag(allProducts["productWindows8Pro"], "computer");
            AddProductTag(allProducts["productCustomTShirt"], "cool");
            AddProductTag(allProducts["productCustomTShirt"], "shirt");
            AddProductTag(allProducts["productCustomTShirt"], "apparel");
            AddProductTag(allProducts["productElegantGemstoneNecklace"], "jewelry");
            AddProductTag(allProducts["productElegantGemstoneNecklace"], "awesome");
            AddProductTag(allProducts["productFlowerGirlBracelet"], "awesome");
            AddProductTag(allProducts["productFlowerGirlBracelet"], "jewelry");
            AddProductTag(allProducts["productFirstPrizePies"], "book");
            AddProductTag(allProducts["productAdidas"], "cool");
            AddProductTag(allProducts["productAdidas"], "shoes");
            AddProductTag(allProducts["productAdidas"], "apparel");
            AddProductTag(allProducts["productLenovoIdeaCentre"], "awesome");
            AddProductTag(allProducts["productLenovoIdeaCentre"], "computer");
            AddProductTag(allProducts["productSamsungSeries"], "nice");
            AddProductTag(allProducts["productSamsungSeries"], "computer");
            AddProductTag(allProducts["productSamsungSeries"], "compact");
            AddProductTag(allProducts["productHpSpectre"], "nice");
            AddProductTag(allProducts["productHpSpectre"], "computer");
            AddProductTag(allProducts["productHpEnvy"], "computer");
            AddProductTag(allProducts["productHpEnvy"], "cool");
            AddProductTag(allProducts["productHpEnvy"], "compact");
            AddProductTag(allProducts["productObeyHat"], "apparel");
            AddProductTag(allProducts["productObeyHat"], "cool");
            AddProductTag(allProducts["productLeviJeans"], "cool");
            AddProductTag(allProducts["productLeviJeans"], "jeans");
            AddProductTag(allProducts["productLeviJeans"], "apparel");
            AddProductTag(allProducts["productSoundForge"], "game");
            AddProductTag(allProducts["productSoundForge"], "computer");
            AddProductTag(allProducts["productSoundForge"], "cool");
            AddProductTag(allProducts["productNightVision"], "awesome");
            AddProductTag(allProducts["productNightVision"], "digital");
            AddProductTag(allProducts["productSunglasses"], "apparel");
            AddProductTag(allProducts["productSunglasses"], "cool");
            AddProductTag(allProducts["productHtcOneMini"], "awesome");
            AddProductTag(allProducts["productHtcOneMini"], "compact");
            AddProductTag(allProducts["productHtcOneMini"], "cell");
            AddProductTag(allProducts["productIfYouWait"], "digital");
            AddProductTag(allProducts["productIfYouWait"], "awesome");
            AddProductTag(allProducts["productNokiaLumia"], "awesome");
            AddProductTag(allProducts["productNokiaLumia"], "cool");
            AddProductTag(allProducts["productNokiaLumia"], "camera");
            AddProductTag(allProducts["productScienceAndFaith"], "digital");
            AddProductTag(allProducts["productScienceAndFaith"], "awesome");
            AddProductTag(allProducts["productPrideAndPrejudice"], "book");
            AddProductTag(allProducts["productLenovoThinkpad"], "awesome");
            AddProductTag(allProducts["productLenovoThinkpad"], "computer");
            AddProductTag(allProducts["productLenovoThinkpad"], "compact");
            AddProductTag(allProducts["productNikeZoom"], "jeans");
            AddProductTag(allProducts["productNikeZoom"], "cool");
            AddProductTag(allProducts["productNikeZoom"], "apparel");
            AddProductTag(allProducts["productEngagementRing"], "jewelry");
            AddProductTag(allProducts["productEngagementRing"], "awesome");
        }

        protected virtual void InstallRelatedProducts(Dictionary<string, Product> allProducts)
        {
            //related products
            var relatedProducts = new List<RelatedProduct>
            {
                new RelatedProduct
                {
                    ProductId1 = allProducts["productFlowerGirlBracelet"].Id,
                    ProductId2 = allProducts["productEngagementRing"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productFlowerGirlBracelet"].Id,
                    ProductId2 = allProducts["productElegantGemstoneNecklace"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productEngagementRing"].Id,
                    ProductId2 = allProducts["productFlowerGirlBracelet"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productEngagementRing"].Id,
                ...
                new RelatedProduct
                {
                    ProductId1 = allProducts["productElegantGemstoneNecklace"].Id,
                    ProductId2 = allProducts["productFlowerGirlBracelet"].Id,
                },
                new RelatedProduct
                {
                ...
                new RelatedProduct
                {
                    ProductId1 = allProducts["productIfYouWait"].Id,
                    ProductId2 = allProducts["productNightVision"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productIfYouWait"].Id,
                    ProductId2 = allProducts["productScienceAndFaith"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productNightVision"].Id,
                    ProductId2 = allProducts["productIfYouWait"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productNightVision"].Id,
                ...
                new RelatedProduct
                {
                    ProductId1 = allProducts["productPrideAndPrejudice"].Id,
                    ProductId2 = allProducts["productFirstPrizePies"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productPrideAndPrejudice"].Id,
                    ProductId2 = allProducts["productFahrenheit"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productFirstPrizePies"].Id,
                    ProductId2 = allProducts["productPrideAndPrejudice"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productFirstPrizePies"].Id,
                ...
                new RelatedProduct
                {
                    ProductId1 = allProducts["productFahrenheit"].Id,
                    ProductId2 = allProducts["productFirstPrizePies"].Id,
                },
                new RelatedProduct
                {
                ...
                new RelatedProduct
                {
                    ProductId1 = allProducts["productAsusN551JK"].Id,
                    ProductId2 = allProducts["productLenovoThinkpad"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productAsusN551JK"].Id,
                    ProductId2 = allProducts["productAppleMacBookPro"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productAsusN551JK"].Id,
                    ProductId2 = allProducts["productSamsungSeries"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productAsusN551JK"].Id,
                    ProductId2 = allProducts["productHpSpectre"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productLenovoThinkpad"].Id,
                    ProductId2 = allProducts["productAsusN551JK"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productLenovoThinkpad"].Id,
                ...
                {
                    ProductId1 = allProducts["productLenovoThinkpad"].Id,
                    ProductId2 = allProducts["productHpEnvy"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productAppleMacBookPro"].Id,
                    ProductId2 = allProducts["productLenovoThinkpad"].Id,
                },
                new RelatedProduct
                {
                ...
                new RelatedProduct
                {
                    ProductId1 = allProducts["productHpSpectre"].Id,
                    ProductId2 = allProducts["productLenovoThinkpad"].Id,
                },
                new RelatedProduct
                {
                ...
                new RelatedProduct
                {
                    ProductId1 = allProducts["productHpEnvy"].Id,
                    ProductId2 = allProducts["productAsusN551JK"].Id,
                },
                new RelatedProduct
                {
                ...
                new RelatedProduct
                {
                    ProductId1 = allProducts["productSamsungSeries"].Id,
                    ProductId2 = allProducts["productAsusN551JK"].Id,
                },
                new RelatedProduct
                {
                ...
                new RelatedProduct
                {
                    ProductId1 = allProducts["productLeica"].Id,
                    ProductId2 = allProducts["productHtcOneMini"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productLeica"].Id,
                    ProductId2 = allProducts["productNikonD5500DSLR"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productLeica"].Id,
                    ProductId2 = allProducts["productAppleICam"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productLeica"].Id,
                    ProductId2 = allProducts["productNokiaLumia"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productHtcOne"].Id,
                    ProductId2 = allProducts["productHtcOneMini"].Id,
                },
                new RelatedProduct
                {
                ...
                {
                    ProductId1 = allProducts["productHtcOne"].Id,
                    ProductId2 = allProducts["productBeatsPill"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productHtcOne"].Id,
                    ProductId2 = allProducts["productPortableSoundSpeakers"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productHtcOneMini"].Id,
                    ProductId2 = allProducts["productHtcOne"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productHtcOneMini"].Id,
                ...
                new RelatedProduct
                {
                    ProductId1 = allProducts["productNokiaLumia"].Id,
                    ProductId2 = allProducts["productHtcOne"].Id,
                },
                new RelatedProduct
                {
                ...
                new RelatedProduct
                {
                    ProductId1 = allProducts["productAdidas"].Id,
                    ProductId2 = allProducts["productLeviJeans"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productAdidas"].Id,
                    ProductId2 = allProducts["productNikeFloral"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productAdidas"].Id,
                    ProductId2 = allProducts["productNikeZoom"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productAdidas"].Id,
                    ProductId2 = allProducts["productNikeTailwind"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productLeviJeans"].Id,
                    ProductId2 = allProducts["productAdidas"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productLeviJeans"].Id,
                ...
                new RelatedProduct
                {
                    ProductId1 = allProducts["productCustomTShirt"].Id,
                    ProductId2 = allProducts["productLeviJeans"].Id,
                },
                new RelatedProduct
                {
                ...
                {
                    ProductId1 = allProducts["productCustomTShirt"].Id,
                    ProductId2 = allProducts["productOversizedWomenTShirt"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productCustomTShirt"].Id,
                    ProductId2 = allProducts["productObeyHat"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productDigitalStorm"].Id,
                    ProductId2 = allProducts["productBuildComputer"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productDigitalStorm"].Id,
                    ProductId2 = allProducts["productLenovoIdeaCentre"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productDigitalStorm"].Id,
                ...
                new RelatedProduct
                {
                    ProductId1 = allProducts["productLenovoIdeaCentre"].Id,
                    ProductId2 = allProducts["productBuildComputer"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productLenovoIdeaCentre"].Id,
                    ProductId2 = allProducts["productDigitalStorm"].Id,
                },
                new RelatedProduct
                {
                    ProductId1 = allProducts["productLenovoIdeaCentre"].Id,
        ...
        protected virtual void InstallStockQuantityHistory(Dictionary<string, Product> allProducts)
        {
            foreach (var product in allProducts.Values)
            {
        ...
        protected virtual void InstallProductsReview(Dictionary<string, Product> allProducts, Customer defaultCustomer, Store defaultStore)
        {
            //reviews
            ...
            _productRepository.Update(allProducts.Values);
        }
        
        protected virtual void InstallGiftCardProducts(ProductTemplate productTemplateSimple, Dictionary<string, Product> allProducts, IPictureService pictureService, DeliveryDate deliveryDate)
        {
            ...
            allProducts.Add("product25GiftCard", product25GiftCard);
            product25GiftCard.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_25giftcart.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(product25GiftCard.Name)),
                DisplayOrder = 1,
            });
            ...
            var product50GiftCard = new Product
            {
                ...
                FullDescription =
                    "<p>Gift Cards must be redeemed through our site Web site toward the purchase of eligible products. Purchases are deducted from the GiftCard balance. Any unused balance will be placed in the recipient's GiftCard account when redeemed. If an order exceeds the amount of the GiftCard, the balance must be paid with a credit card or other available payment method.</p>",
                ProductTemplateId = productTemplateSimple.Id,
            ...
            allProducts.Add("product50GiftCard", product50GiftCard);
            product50GiftCard.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_50giftcart.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(product50GiftCard.Name)),
                DisplayOrder = 1,
            });
            ...
            allProducts.Add("product100GiftCard", product100GiftCard);
            product100GiftCard.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_100giftcart.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(product100GiftCard.Name)),
                DisplayOrder = 1,
            });
            _productRepository.Insert(product100GiftCard);
        }

        protected virtual void InstallJewelryProducts(ProductTemplate productTemplateSimple, Dictionary<string, Product> allProducts, IPictureService pictureService)
        {
            ...
            allProducts.Add("productElegantGemstoneNecklace", productElegantGemstoneNecklace);
            productElegantGemstoneNecklace.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_GemstoneNecklaces.jpg"),
                    MimeTypes.ImagePJpeg, pictureService.GetPictureSeName(productElegantGemstoneNecklace.Name)),
                DisplayOrder = 1,
            });
            ...
            allProducts.Add("productFlowerGirlBracelet", productFlowerGirlBracelet);
            productFlowerGirlBracelet.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_FlowerBracelet.jpg"),
                    MimeTypes.ImagePJpeg, pictureService.GetPictureSeName(productFlowerGirlBracelet.Name)),
                DisplayOrder = 1,
            });
            ...
            var productEngagementRing = new Product
            {
                ...
                FullDescription =
                    "<p>Dazzle her with this gleaming 14 karat white gold vintage proposal. A ravishing collection of 11 decadent diamonds come together to invigorate a superbly ornate gold shank. Total diamond weight on this antique style engagement ring equals 1 1/4 carat (ctw). Item includes diamond certificate.</p>",
                ProductTemplateId = productTemplateSimple.Id,
            ...
            allProducts.Add("productEngagementRing", productEngagementRing);
            productEngagementRing.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_EngagementRing_1.jpg"),
                    MimeTypes.ImagePJpeg, pictureService.GetPictureSeName(productEngagementRing.Name)),
                DisplayOrder = 1,
            });
            _productRepository.Insert(productEngagementRing);
        }

        protected virtual void InstallBookProducts(ProductTemplate productTemplateSimple, Dictionary<string, Product> allProducts, IPictureService pictureService)
        {
            ...
            allProducts.Add("productFahrenheit", productFahrenheit);
            productFahrenheit.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_Fahrenheit451.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productFahrenheit.Name)),
                DisplayOrder = 1,
            });
            ...
            allProducts.Add("productFirstPrizePies", productFirstPrizePies);
            productFirstPrizePies.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_FirstPrizePies.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productFirstPrizePies.Name)),
                DisplayOrder = 1,
            });
            ...
            var productPrideAndPrejudice = new Product
            {
                ...
                FullDescription =
                    "<p>Set in England in the early 19th century, Pride and Prejudice tells the story of Mr and Mrs Bennet's five unmarried daughters after the rich and eligible Mr Bingley and his status-conscious friend, Mr Darcy, have moved into their neighbourhood. While Bingley takes an immediate liking to the eldest Bennet daughter, Jane, Darcy has difficulty adapting to local society and repeatedly clashes with the second-eldest Bennet daughter, Elizabeth.</p>",
                ProductTemplateId = productTemplateSimple.Id,
            ...
            allProducts.Add("productPrideAndPrejudice", productPrideAndPrejudice);
            productPrideAndPrejudice.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_PrideAndPrejudice.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productPrideAndPrejudice.Name)),
                DisplayOrder = 1,
            });
            _productRepository.Insert(productPrideAndPrejudice);
        }

        protected virtual void InstallDigitalDownloadProducts(ProductTemplate productTemplateSimple, Dictionary<string, Product> allProducts, IPictureService pictureService, IDownloadService downloadService, string sampleDownloadsPath)
        {
            var sampleImagesPath = GetSamplesPath();
            ...
            var productNightVision = new Product
            {
                ...
                FullDescription =
                    "<p>Original Release Date: September 4, 2012</p><p>Release Date: September 4, 2012</p><p>Genre - Alternative rock, indie rock, electronic rock</p><p>Label - Interscope/KIDinaKORNER</p><p>Copyright: (C) 2011 Interscope Records</p>",
                ProductTemplateId = productTemplateSimple.Id,
                //SeName = "poker-face",
                AllowCustomerReviews = true,
                Price = 2.8M,
            ...
            allProducts.Add("productNightVision", productNightVision);
            productNightVision.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_NightVisions.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productNightVision.Name)),
                DisplayOrder = 1,
            });
            ...
            var productIfYouWait = new Product
            {
                ...
                FullDescription =
                    "<p>Original Release Date: September 6, 2013</p><p>Genre - Electronica, dream pop downtempo, pop</p><p>Label - Metal & Dust/Ministry of Sound</p><p>Producer - Tim Bran, Roy Kerr London, Grammar</p><p>Length - 43:22</p>",
                ProductTemplateId = productTemplateSimple.Id,
            ...
            allProducts.Add("productIfYouWait", productIfYouWait);

            productIfYouWait.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_IfYouWait.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productIfYouWait.Name)),
                DisplayOrder = 1,
            });
            ...
            var productScienceAndFaith = new Product
            {
                ...
                FullDescription =
                    "<p># Original Release Date: September 10, 2010<br /># Label: RCA, Epic/Phonogenic(America)<br /># Copyright: 2010 RCA Records.</p>",
                ProductTemplateId = productTemplateSimple.Id,
            ...
            allProducts.Add("productScienceAndFaith", productScienceAndFaith);
            productScienceAndFaith.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_ScienceAndFaith.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productScienceAndFaith.Name)),
                DisplayOrder = 1,
            });
            _productRepository.Insert(productScienceAndFaith);
        }

        protected virtual void InstallAccessoryProducts(ProductTemplate productTemplateSimple, Dictionary<string, Product> allProducts, IPictureService pictureService, ProductAvailabilityRange productAvailabilityRange)
        {
            var sampleImagesPath = GetSamplesPath();
            ...
            allProducts.Add("productObeyHat", productObeyHat);
            productObeyHat.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_hat.jpg"),
                    MimeTypes.ImagePJpeg, pictureService.GetPictureSeName(productObeyHat.Name)),
                DisplayOrder = 1,
            });
            ...
            var productBelt = new Product
            {
                ...
                FullDescription =
                    "<p>Reversible belt in Horseferry check with smooth leather trim</p><p>Leather lining, polished metal buckle</p>",
                ProductTemplateId = productTemplateSimple.Id,
            ...
            allProducts.Add("productBelt", productBelt);
            productBelt.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_Belt.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productBelt.Name)),
                DisplayOrder = 1,
            });
            ...
            var productSunglasses = new Product
            {
                ...
                FullDescription =
                    "<p>Since 1937, Ray-Ban can genuinely claim the title as the world's leading sunglasses and optical eyewear brand. Combining the best of fashion and sports performance, the Ray-Ban line of Sunglasses delivers a truly classic style that will have you looking great today and for years to come.</p>",
                ProductTemplateId = productTemplateSimple.Id,
            ...
            allProducts.Add("productSunglasses", productSunglasses);
            productSunglasses.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_Sunglasses.jpg"),
                    MimeTypes.ImagePJpeg, pictureService.GetPictureSeName(productSunglasses.Name)),
                DisplayOrder = 1,
            });
            _productRepository.Insert(productSunglasses);
        }

        protected virtual void InstallClothingProducts(ProductTemplate productTemplateSimple, Dictionary<string, Product> allProducts, IPictureService pictureService)
        {
            var sampleImagesPath = GetSamplesPath();
            ...
            allProducts.Add("productNikeTailwind", productNikeTailwind);
            productNikeTailwind.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_NikeShirt.jpg"),
                    MimeTypes.ImagePJpeg, pictureService.GetPictureSeName(productNikeTailwind.Name)),
                DisplayOrder = 1,
            });
            ...
            allProducts.Add("productOversizedWomenTShirt", productOversizedWomenTShirt);
            productOversizedWomenTShirt.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_WomenTShirt.jpg"),
                    MimeTypes.ImagePJpeg, pictureService.GetPictureSeName(productOversizedWomenTShirt.Name)),
                DisplayOrder = 1,
            });
            ...
            allProducts.Add("productCustomTShirt", productCustomTShirt);
            productCustomTShirt.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_CustomTShirt.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productCustomTShirt.Name)),
                DisplayOrder = 1,
            });
            ...
            allProducts.Add("productLeviJeans", productLeviJeans);

            productLeviJeans.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_LeviJeans_1.jpg"),
                    MimeTypes.ImagePJpeg, pictureService.GetPictureSeName(productLeviJeans.Name)),
                DisplayOrder = 1,
            });
            productLeviJeans.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_LeviJeans_2.jpg"),
                    MimeTypes.ImagePJpeg, pictureService.GetPictureSeName(productLeviJeans.Name)),
                DisplayOrder = 2,
            });
        ...
        protected virtual void InstallShoesProducts(ProductTemplate productTemplateSimple, Dictionary<string, Product> allProducts, IPictureService pictureService)
        {
            var sampleImagesPath = GetSamplesPath();
            ...
            var productNikeFloral = new Product
            {
                ...
                FullDescription =
                    "<p>Each Rosh Run is personalized and exclusive, handmade in our workshop Custom. Run Your Rosh creations born from the hand of an artist specialized in sneakers, more than 10 years of experience.</p>",
                ProductTemplateId = productTemplateSimple.Id,
                        ...
                        ProductAttributeValues =
                        {
                            new ProductAttributeValue
                            {
                                ...
                                ImageSquaresPictureId =
                                    pictureService
                                        .InsertPicture(File.ReadAllBytes(sampleImagesPath + "p_attribute_print_2.jpg"),
                                            MimeTypes.ImagePJpeg, pictureService.GetPictureSeName("Natural Print")).Id,
                            },
                            new ProductAttributeValue
                            {
                                AttributeValueType = AttributeValueType.Simple,
                                ...
                                ImageSquaresPictureId =
                                    pictureService
                                        .InsertPicture(File.ReadAllBytes(sampleImagesPath + "p_attribute_print_1.jpg"),
                                            MimeTypes.ImagePJpeg, pictureService.GetPictureSeName("Fresh Print")).Id,
                            },
                        }
                    }
                },
            ...
            allProducts.Add("productNikeFloral", productNikeFloral);
            productNikeFloral.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_NikeFloralShoe_1.jpg"),
                    MimeTypes.ImagePJpeg, pictureService.GetPictureSeName(productNikeFloral.Name)),
                DisplayOrder = 1,
            });
            productNikeFloral.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_NikeFloralShoe_2.jpg"),
                    MimeTypes.ImagePJpeg, pictureService.GetPictureSeName(productNikeFloral.Name)),
                DisplayOrder = 2,
            });
            _productRepository.Insert(productNikeFloral);

            productNikeFloral.ProductAttributeMappings.First(x => x.ProductAttribute.Name == "Print").ProductAttributeValues
                .First(x => x.Name == "Natural").PictureId = productNikeFloral.ProductPictures.ElementAt(0).PictureId;
            productNikeFloral.ProductAttributeMappings.First(x => x.ProductAttribute.Name == "Print").ProductAttributeValues
                .First(x => x.Name == "Fresh").PictureId = productNikeFloral.ProductPictures.ElementAt(1).PictureId;
            ...
            allProducts.Add("productAdidas", productAdidas);
            productAdidas.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_adidas.jpg"),
                    MimeTypes.ImagePJpeg, pictureService.GetPictureSeName(productAdidas.Name)),
                DisplayOrder = 1,
            });
            productAdidas.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_adidas_2.jpg"),
                    MimeTypes.ImagePJpeg, pictureService.GetPictureSeName(productAdidas.Name)),
                DisplayOrder = 2,
            });
            productAdidas.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_adidas_3.jpg"),
                    MimeTypes.ImagePJpeg, pictureService.GetPictureSeName(productAdidas.Name)),
                DisplayOrder = 3,
            });
            ...
            productAdidas.ProductAttributeMappings.First(x => x.ProductAttribute.Name == "Color").ProductAttributeValues
                .First(x => x.Name == "Red").PictureId = productAdidas.ProductPictures.ElementAt(0).PictureId;
            productAdidas.ProductAttributeMappings.First(x => x.ProductAttribute.Name == "Color").ProductAttributeValues
                .First(x => x.Name == "Blue").PictureId = productAdidas.ProductPictures.ElementAt(1).PictureId;
            productAdidas.ProductAttributeMappings.First(x => x.ProductAttribute.Name == "Color").ProductAttributeValues
                .First(x => x.Name == "Silver").PictureId = productAdidas.ProductPictures.ElementAt(2).PictureId;
            ...
            allProducts.Add("productNikeZoom", productNikeZoom);
            productNikeZoom.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_NikeZoom.jpg"),
                    MimeTypes.ImagePJpeg, pictureService.GetPictureSeName(productNikeZoom.Name)),
                DisplayOrder = 1,
            });
            _productRepository.Insert(productNikeZoom);
        }

        protected virtual void InstallOtherProducts(ProductTemplate productTemplateSimple, Dictionary<string, Product> allProducts, IPictureService pictureService)
        {
            var sampleImagesPath = GetSamplesPath();
            ...
            var productBeatsPill = new Product
            {
                ...
                FullDescription =
                    "<ul><li>Pair and play with your Bluetooth® device with 30 foot range</li><li>Built-in speakerphone</li><li>7 hour rechargeable battery</li><li>Power your other devices with USB charge out</li><li>Tap two Beats Pills™ together for twice the sound with Beats Bond™</li></ul>",
                ProductTemplateId = productTemplateSimple.Id,
            ...
            allProducts.Add("productBeatsPill", productBeatsPill);
            productBeatsPill.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_PillBeats_1.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productBeatsPill.Name)),
                DisplayOrder = 1,
            });
            productBeatsPill.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_PillBeats_2.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productBeatsPill.Name)),
                DisplayOrder = 2,
            });
            ...
            var productUniversalTabletCover = new Product
            {
                ...
                FullDescription =
                    "<p>Made of durable polyurethane, our Universal Cover is slim, lightweight, and strong, with protective corners that stretch to hold most 7 and 8-inch tablets securely. This tough case helps protects your tablet from bumps, scuffs, and dings.</p>",
                ProductTemplateId = productTemplateSimple.Id,
            ...
            allProducts.Add("productUniversalTabletCover", productUniversalTabletCover);
            productUniversalTabletCover.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_TabletCover.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productUniversalTabletCover.Name)),
                DisplayOrder = 1,
            });
            ...
            allProducts.Add("productPortableSoundSpeakers", productPortableSoundSpeakers);
            productPortableSoundSpeakers.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_Speakers.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productPortableSoundSpeakers.Name)),
                DisplayOrder = 1,
            });
            _productRepository.Insert(productPortableSoundSpeakers);
        }

        protected virtual void InstallCellPhoneProducts(ProductTemplate productTemplateSimple, Dictionary<string, Product> allProducts, IPictureService pictureService)
        {
            var sampleImagesPath = GetSamplesPath();
            ...
            var productHtcOne = new Product
            {
                ...
                FullDescription =
                    "<p><b>HTC One (M8) Cell Phone for Sprint:</b> With its brushed-metal design and wrap-around unibody frame, the HTC One (M8) is designed to fit beautifully in your hand. It's fun to use with amped up sound and a large Full HD touch screen, and intuitive gesture controls make it seem like your phone almost knows what you need before you do. <br /><br />Sprint Easy Pay option available in store.</p>",
                ProductTemplateId = productTemplateSimple.Id,
            ...
            allProducts.Add("productHtcOne", productHtcOne);
            productHtcOne.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_HTC_One_M8.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productHtcOne.Name)),
                DisplayOrder = 1,
            });
            ...
            var productHtcOneMini = new Product
            {
                ...
                FullDescription =
                    "<p>HTC One mini smartphone with 4.30-inch 720x1280 display powered by 1.4GHz processor alongside 1GB RAM and 4-Ultrapixel rear camera.</p>",
                ProductTemplateId = productTemplateSimple.Id,
            ...
            allProducts.Add("productHtcOneMini", productHtcOneMini);
            productHtcOneMini.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_HTC_One_Mini_1.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productHtcOneMini.Name)),
                DisplayOrder = 1,
            });
            productHtcOneMini.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_HTC_One_Mini_2.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productHtcOneMini.Name)),
                DisplayOrder = 2,
            });
            ...
            var productNokiaLumia = new Product
            {
                ...
                FullDescription =
                    "<p>Capture special moments for friends and family with this Nokia Lumia 1020 32GB WHITE cell phone that features an easy-to-use 41.0MP rear-facing camera and a 1.2MP front-facing camera. The AMOLED touch screen offers 768 x 1280 resolution for crisp visuals.</p>",
                ProductTemplateId = productTemplateSimple.Id,
            ...
            allProducts.Add("productNokiaLumia", productNokiaLumia);
            productNokiaLumia.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_Lumia1020.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productNokiaLumia.Name)),
                DisplayOrder = 1,
            });
            _productRepository.Insert(productNokiaLumia);
        }

        protected virtual void InstallCameraAndPhotoProducts(ProductTemplate productTemplateSimple, Dictionary<string, Product> allProducts, IPictureService pictureService, ProductTemplate productTemplateGrouped)
        {
            var sampleImagesPath = GetSamplesPath();
            ...
            allProducts.Add("productNikonD5500DSLR", productNikonD5500DSLR);
            productNikonD5500DSLR.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_NikonCamera_1.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productNikonD5500DSLR.Name)),
                DisplayOrder = 1,
            });
            productNikonD5500DSLR.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_NikonCamera_2.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productNikonD5500DSLR.Name)),
                DisplayOrder = 2,
            });
            ...
            allProducts.Add("productNikonD5500DSLR_associated_1", productNikonD5500DSLR_associated_1);
            productNikonD5500DSLR_associated_1.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_NikonCamera_black.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName("Canon Digital SLR Camera - Black")),
                DisplayOrder = 1,
            });
            ...
            allProducts.Add("productNikonD5500DSLR_associated_2", productNikonD5500DSLR_associated_2);
            productNikonD5500DSLR_associated_2.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_NikonCamera_red.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName("Canon Digital SLR Camera - Silver")),
                DisplayOrder = 1,
            });
            ...
            allProducts.Add("productLeica", productLeica);
            productLeica.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_LeicaT.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productLeica.Name)),
                DisplayOrder = 1,
            });
            ...
            allProducts.Add("productAppleICam", productAppleICam);
            productAppleICam.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_iCam.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productAppleICam.Name)),
                DisplayOrder = 1,
            });
            _productRepository.Insert(productAppleICam);
        }

        protected virtual void InstallSoftwareProducts(ProductTemplate productTemplateSimple, Dictionary<string, Product> allProducts, IPictureService pictureService)
        {
            var sampleImagesPath = GetSamplesPath();
            ...
            allProducts.Add("productAdobePhotoshop", productAdobePhotoshop);
            productAdobePhotoshop.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_AdobePhotoshop.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productAdobePhotoshop.Name)),
                DisplayOrder = 1,
            });
            ...
            allProducts.Add("productWindows8Pro", productWindows8Pro);
            productWindows8Pro.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_Windows8.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productWindows8Pro.Name)),
                DisplayOrder = 1,
            });
            ...
            allProducts.Add("productSoundForge", productSoundForge);
            productSoundForge.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_SoundForge.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productSoundForge.Name)),
                DisplayOrder = 1,
            });
            _productRepository.Insert(productSoundForge);
        }

        protected virtual void InstallNotebookProducts(ProductTemplate productTemplateSimple, Dictionary<string, Product> allProducts, IPictureService pictureService)
        {
            var sampleImagesPath = GetSamplesPath();
            ...
            var productAppleMacBookPro = new Product
            {
                ...
                ProductSpecificationAttributes =
                {
                    new ProductSpecificationAttribute
                    {
                        ...
                        DisplayOrder = 1,
                        SpecificationAttributeOption = _specificationAttributeRepository.Table
                            .Single(sa => sa.Name == "Screensize").SpecificationAttributeOptions
                            .Single(sao => sao.Name == "13.0''")
                    },
                    new ProductSpecificationAttribute
                    {
                        AllowFiltering = true,
                        ...
                        SpecificationAttributeOption = _specificationAttributeRepository.Table
                            ...
                            .Single(sao => sao.Name == "Intel Core i5")
                    },
                    new ProductSpecificationAttribute
                    {
                        AllowFiltering = true,
                        ShowOnProductPage = true,
                        DisplayOrder = 3,
                        SpecificationAttributeOption = _specificationAttributeRepository.Table.Single(sa => sa.Name == "Memory")
                            .SpecificationAttributeOptions.Single(sao => sao.Name == "4 GB")
                    }
                    //new ProductSpecificationAttribute
                    //{
                    //    AllowFiltering = false,
            ...
            allProducts.Add("productAppleMacBookPro", productAppleMacBookPro);
            productAppleMacBookPro.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_macbook_1.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productAppleMacBookPro.Name)),
                DisplayOrder = 1,
            });
            productAppleMacBookPro.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_macbook_2.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productAppleMacBookPro.Name)),
                DisplayOrder = 2,
            });
            ...
            var productAsusN551JK = new Product
            {
                ...
                FullDescription =
                    "<p>The ASUS N550JX combines cutting-edge audio and visual technology to deliver an unsurpassed multimedia experience. A full HD wide-view IPS panel is tailor-made for watching movies and the intuitive touchscreen makes for easy, seamless navigation. ASUS has paired the N550JX’s impressive display with SonicMaster Premium, co-developed with Bang & Olufsen ICEpower® audio experts, for true surround sound. A quad-speaker array and external subwoofer combine for distinct vocals and a low bass that you can feel.</p>",
                ProductTemplateId = productTemplateSimple.Id,
                ...
                ProductSpecificationAttributes =
                {
                    ...
                    new ProductSpecificationAttribute
                    {
                        ...
                        SpecificationAttributeOption = _specificationAttributeRepository.Table
                            .Single(sa => sa.Name == "CPU Type").SpecificationAttributeOptions
                            .Single(sao => sao.Name == "Intel Core i7")
                    },
                    new ProductSpecificationAttribute
                    {
                        AllowFiltering = true,
                        ...
                        DisplayOrder = 3,
                        SpecificationAttributeOption = _specificationAttributeRepository.Table.Single(sa => sa.Name == "Memory")
                            .SpecificationAttributeOptions.Single(sao => sao.Name == "16 GB")
                    },
                    new ProductSpecificationAttribute
                    {
                        AllowFiltering = false,
                        ...
                        DisplayOrder = 4,
                        SpecificationAttributeOption = _specificationAttributeRepository.Table
                            .Single(sa => sa.Name == "Hard drive").SpecificationAttributeOptions
                            .Single(sao => sao.Name == "1 TB")
                    }
                }
            };
            allProducts.Add("productAsusN551JK", productAsusN551JK);
            productAsusN551JK.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_asuspc_N551JK.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productAsusN551JK.Name)),
                DisplayOrder = 1,
            });
            ...
            var productSamsungSeries = new Product
            {
                ...
                ProductSpecificationAttributes =
                {
                    ...
                    new ProductSpecificationAttribute
                    {
                        ...
                        DisplayOrder = 3,
                        SpecificationAttributeOption = _specificationAttributeRepository.Table.Single(sa => sa.Name == "Memory")
                            .SpecificationAttributeOptions.Single(sao => sao.Name == "8 GB")
                    },
                    new ProductSpecificationAttribute
                    {
                        AllowFiltering = false,
                        ...
                        SpecificationAttributeOption = _specificationAttributeRepository.Table
                            .Single(sa => sa.Name == "Hard drive").SpecificationAttributeOptions
                            .Single(sao => sao.Name == "128 GB")
                    }
                }
            };
            allProducts.Add("productSamsungSeries", productSamsungSeries);
            productSamsungSeries.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_SamsungNP900X4C.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productSamsungSeries.Name)),
                DisplayOrder = 1,
            });
            ...
            allProducts.Add("productHpSpectre", productHpSpectre);
            productHpSpectre.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_HPSpectreXT_1.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productHpSpectre.Name)),
                DisplayOrder = 1,
            });
            productHpSpectre.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_HPSpectreXT_2.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productHpSpectre.Name)),
                DisplayOrder = 2,
            });
            ...
            var productHpEnvy = new Product
            {
                ...
                ProductSpecificationAttributes =
                {
                    ...
                    new ProductSpecificationAttribute
                    {
                        ...
                        SpecificationAttributeOption = _specificationAttributeRepository.Table
                            .Single(sa => sa.Name == "Hard drive").SpecificationAttributeOptions
                            .Single(sao => sao.Name == "500 GB")
                    }
                }
            };
            allProducts.Add("productHpEnvy", productHpEnvy);
            productHpEnvy.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_HpEnvy6.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productHpEnvy.Name)),
                DisplayOrder = 1,
            });
            ...
            allProducts.Add("productLenovoThinkpad", productLenovoThinkpad);
            productLenovoThinkpad.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_LenovoThinkpad.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productLenovoThinkpad.Name)),
                DisplayOrder = 1,
            });
            _productRepository.Insert(productLenovoThinkpad);
        }

        protected virtual void InstallDesktopProducts(ProductTemplate productTemplateSimple, Dictionary<string, Product> allProducts, IPictureService pictureService)
        {
            var sampleImagesPath = GetSamplesPath();
            ...
            allProducts.Add("productBuildComputer", productBuildComputer);
            productBuildComputer.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_Desktops_1.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productBuildComputer.Name)),
                DisplayOrder = 1,
            });
            productBuildComputer.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_Desktops_2.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productBuildComputer.Name)),
                DisplayOrder = 2,
            });
            ...
            allProducts.Add("productDigitalStorm", productDigitalStorm);
            productDigitalStorm.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_DigitalStorm.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productDigitalStorm.Name)),
                DisplayOrder = 1,
            });
            ...
            var productLenovoIdeaCentre = new Product
            {
                ...
                ShortDescription = "",
                FullDescription =
                    "<p>The A600 features a 21.5in screen, DVD or optional Blu-Ray drive, support for the full beans 1920 x 1080 HD, Dolby Home Cinema certification and an optional hybrid analogue/digital TV tuner.</p><p>Connectivity is handled by 802.11a/b/g - 802.11n is optional - and an ethernet port. You also get four USB ports, a Firewire slot, a six-in-one card reader and a 1.3- or two-megapixel webcam.</p>",
                ProductTemplateId = productTemplateSimple.Id,
            ...
            allProducts.Add("productLenovoIdeaCentre", productLenovoIdeaCentre);
            productLenovoIdeaCentre.ProductPictures.Add(new ProductPicture
            {
                Picture = pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "product_LenovoIdeaCentre.jpeg"),
                    MimeTypes.ImageJpeg, pictureService.GetPictureSeName(productLenovoIdeaCentre.Name)),
                DisplayOrder = 1,
            });
